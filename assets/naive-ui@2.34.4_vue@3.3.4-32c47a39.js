...
`),kf=J({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){pr("-base-wave",Sf,xe(e,"clsPrefix"));const t=D(null),o=D(!1);let r=null;return ao(()=>{r!==null&&window.clearTimeout(r)}),{active:o,selfRef:t,play(){r!==null&&(window.clearTimeout(r),o.value=!1,r=null),Ct(()=>{var n;(n=t.value)===null||n===void 0||n.offsetHeight,o.value=!0,r=window.setTimeout(()=>{o.value=!1,r=null},1e3)})}}},render(){const{clsPrefix:e}=this;return i("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),Rf={space:"6px",spaceArrow:"10px",arrowOffset:"10px",arrowOffsetVertical:"10px",arrowHeight:"6px",padding:"8px 14px"},us=e=>{const{boxShadow2:t,popoverColor:o,textColor2:r,borderRadius:n,fontSize:a,dividerColor:s}=e;return Object.assign(Object.assign({},Rf),{fontSize:a,borderRadius:n,color:o,dividerColor:s,textColor:r,boxShadow:t})},zf={name:"Popover",common:Je,self:us},xr=zf,Pf={name:"Popover",common:Te,self:us},Cr=Pf,oi={top:"bottom",bottom:"top",left:"right",right:"left"},Dt="var(--n-arrow-height) * 1.414",$f=y([m("popover",`
 ...
 `),...uu({top:["right-start","left-start"],right:["top-end","bottom-end"],bottom:["right-end","left-end"],left:["top-start","bottom-start"]},(e,t)=>{const o=["right","left"].includes(t),r=o?"width":"height";return e.map(n=>{const a=n.split("-")[1]==="end",l=`calc((${`var(--v-target-${r}, 0px)`} - ${Dt}) / 2)`,d=Fo(n);return y(`[v-placement="${n}"] >`,[m("popover-shared",[T("center-arrow",[m("popover-arrow",`${t}: calc(max(${l}, ${d}) ${a?"+":"-"} var(--v-offset-${o?"left":"top"}));`)])])])})})]);function Fo(e){return["top","bottom"].includes(e.split("-")[0])?"var(--n-arrow-offset)":"var(--n-arrow-offset-vertical)"}function co(e,t){const o=e.split("-")[0],r=["top","bottom"].includes(o)?"height: var(--n-space-arrow);":"width: var(--n-space-arrow);";return y(`[v-placement="${e}"] >`,[m("popover-shared",`
...
`,[y("ul",`
 ...
 align-items: center;
 justify-content: center;
 `,[ro({top:"50%",originalTransform:"translateY(-50%)"})]),Uf()]),P("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
 ...
 box-shadow .3s var(--n-bezier),
 border-color .3s var(--n-bezier);
 `,[Ul({background:"var(--n-color-modal)"}),T("hoverable",[y("&:hover","box-shadow: var(--n-box-shadow);")]),T("content-segmented",[y(">",[P("content",{paddingTop:"var(--n-padding-bottom)"})])]),T("content-soft-segmented",[y(">",[P("content",`
...
`,[Jo(),m("dropdown-option",`
 ...
 transition: color .3s var(--n-bezier);
 `,[T("expanded",[m("icon","transform: rotate(90deg);",[ro({originalTransform:"rotate(90deg)"})]),m("base-icon","transform: rotate(90deg);",[ro({originalTransform:"rotate(90deg)"})])]),m("base-loading",`
 color: var(--n-loading-color);
 transition: color .3s var(--n-bezier);
 position: absolute;
 left: 0;
 ...
 `))]);function Um(){return[T("fixed-left",`
 left: 0;
 position: sticky;
 z-index: 2;
 `,[y("&::after",`
...
`,[sn({enterDuration:"0.3s",leaveDuration:"0.8s"}),m("loading-bar",`
 ...
 `)]),ot("disabled",[ot("selected, child-active",[y("&:focus-within",zl)]),T("selected",[nr(null,[P("icon","color: var(--n-item-icon-color-active-hover-horizontal);"),m("menu-item-content-header",`
 ...
 `)]),ot("disabled",[ot("selected, child-active",[y("&:focus-within",Rl)]),T("selected",[nr(null,[P("arrow","color: var(--n-arrow-color-active-hover);"),P("icon","color: var(--n-item-icon-color-active-hover);"),m("menu-item-content-header",`
 ...
 `,[y("a","color: var(--n-item-text-color-child-active-hover);"),P("extra","color: var(--n-item-text-color-child-active-hover);")])])]),T("selected",[nr(null,[y("&::before","background-color: var(--n-item-color-active-hover);")])]),nr(null,Rl)]),P("icon",`
 grid-area: icon;
 ...
 overflow: hidden;
 padding: 0;
 `,[ws({duration:".2s"})])]),m("menu-item-group",[m("menu-item-group-title",`
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
 ...
 display: flex;
 `,[ws({overflow:"visible",originalTransition:"transform .3s var(--n-bezier)",enterToProps:{transform:"scale(1)"},leaveToProps:{transform:"scale(0.85)"}})]),m("message",`
 box-sizing: border-box;
 display: flex;
 align-items: center;
 transition:
...
`,[P("children-placeholder",`
 ...
 color: var(--n-loading-color);
 transition: color .3s var(--n-bezier);
 `,[ro({left:"50%",top:"50%",originalTransform:"translateX(-50%) translateY(-50%)"})]),P("checked, unchecked",`
 transition: color .3s var(--n-bezier);
 color: var(--n-text-color);
 box-sizing: border-box;
 position: absolute;
