...
`,[y(">",[m("input",[y("&:not(:last-child)",`
 ...
 border-top-left-radius: 0!important;
 border-bottom-left-radius: 0!important;
 `)])])])])])]),fh={},hh=J({name:"InputGroup",props:fh,setup(e){const{mergedClsPrefixRef:t}=je(e);return pr("-input-group",uh,t),{mergedClsPrefix:t}},render(){const{mergedClsPrefix:e}=this;return i("div",{class:`${e}-input-group`},this.$slots)}});function vh(e){const{boxShadow2:t}=e;return{menuBoxShadow:t}}const ph={name:"AutoComplete",common:Te,peers:{InternalSelectMenu:dn,Input:uo},self:vh},mh=ph,ni=xo&&"loading"in document.createElement("img"),gh=(e={})=>{var t;const{root:o=null}=e;return{hash:`${e.rootMargin||"0px 0px 0px 0px"}-${Array.isArray(e.threshold)?e.threshold.join(","):(t=e.threshold)!==null&&t!==void 0?t:"0"}`,options:Object.assign(Object.assign({},e),{root:(typeof o=="string"?document.querySelector(o):o)||document.documentElement})}},ii=new WeakMap,ai=new WeakMap,li=new WeakMap,bh=(e,t,o)=>{if(!e)return()=>{};const r=gh(t),{root:n}=r.options;let a;const s=ii.get(n);s?a=s:(a=new Map,ii.set(n,a));let l,d;a.has(r.hash)?(d=a.get(r.hash),d[1].has(e)||(l=d[0],d[1].add(e),l.observe(e))):(l=new IntersectionObserver(f=>{f.forEach(v=>{if(v.isIntersecting){const p=ai.get(v.target),h=li.get(v.target);p&&p(),h&&(h.value=!0)}})},r.options),l.observe(e),d=[l,new Set([e])],a.set(r.hash,d));let c=!1;const u=()=>{c||(ai.delete(e),li.delete(e),c=!0,d[1].has(e)&&(d[0].unobserve(e),d[1].delete(e)),d[1].size<=0&&a.delete(r.hash),a.size||ii.delete(n))};return ai.set(e,u),li.set(e,o),u},zs=e=>{const{borderRadius:t,avatarColor:o,cardColor:r,fontSize:n,heightTiny:a,heightSmall:s,heightMedium:l,heightLarge:d,heightHuge:c,modalColor:u,popoverColor:f}=e;return{borderRadius:t,fontSize:n,border:`2px solid ${r}`,heightTiny:a,heightSmall:s,heightMedium:l,heightLarge:d,heightHuge:c,color:Ue(r,o),colorModal:Ue(u,o),colorPopover:Ue(f,o)}},xh={name:"Avatar",common:Je,self:zs},Ch=xh,yh={name:"Avatar",common:Te,self:zs},Ps=yh,wh="n-avatar-group",Sh=m("avatar",`
...
`,[Fr(y("&","--n-merged-color: var(--n-color-modal);")),rn(y("&","--n-merged-color: var(--n-color-popover);")),y("img",`
 ...
 `),P("text","line-height: 1.25")]),kh=Object.assign(Object.assign({},be.props),{size:[String,Number],src:String,circle:{type:Boolean,default:void 0},objectFit:String,round:{type:Boolean,default:void 0},bordered:{type:Boolean,default:void 0},onError:Function,fallbackSrc:String,intersectionObserverOptions:Object,lazy:Boolean,onLoad:Function,renderPlaceholder:Function,renderFallback:Function,imgProps:Object,color:String}),qy=J({name:"Avatar",props:kh,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=je(e),r=D(!1);let n=null;const a=D(null),s=D(null),l=()=>{const{value:I}=a;if(I&&(n===null||n!==I.innerHTML)){n=I.innerHTML;const{value:F}=s;if(F){const{offsetWidth:w,offsetHeight:R}=F,{offsetWidth:S,offsetHeight:B}=I,$=.9,z=Math.min(w/S*$,R/B*$,1);I.style.transform=`translateX(-50%) translateY(-50%) scale(${z})`}}},d=Me(wh,null),c=x(()=>{const{size:I}=e;if(I)return I;const{size:F}=d||{};return F||"medium"}),u=be("Avatar","-avatar",Sh,Ch,e,t),f=Me(ms,null),v=x(()=>{if(d)return!0;const{round:I,circle:F}=e;return I!==void 0||F!==void 0?I||F:f?f.roundRef.value:!1}),p=x(()=>d?!0:e.bordered||!1),h=I=>{var F;if(!C.value)return;r.value=!0;const{onError:w,imgProps:R}=e;(F=R==null?void 0:R.onError)===null||F===void 0||F.call(R,I),w&&w(I)};lt(()=>e.src,()=>r.value=!1);const b=x(()=>{const I=c.value,F=v.value,w=p.value,{color:R}=e,{self:{borderRadius:S,fontSize:B,color:$,border:z,colorModal:L,colorPopover:E},common:{cubicBezierEaseInOut:V}}=u.value;let j;return typeof I=="number"?j=`${I}px`:j=u.value.self[te("height",I)],{"--n-font-size":B,"--n-border":w?z:"none","--n-border-radius":F?"50%":S,"--n-color":R||$,"--n-color-modal":R||L,"--n-color-popover":R||E,"--n-bezier":V,"--n-merged-size":`var(--n-avatar-size-override, ${j})`}}),g=o?Qe("avatar",x(()=>{const I=c.value,F=v.value,w=p.value,{color:R}=e;let S="";return I&&(typeof I=="number"?S+=`a${I}`:S+=I[0]),F&&(S+="b"),w&&(S+="c"),R&&(S+=Yr(R)),S}),b,e):void 0,C=D(!e.lazy);qt(()=>{if(ni)return;let I;const F=Pt(()=>{I==null||I(),I=void 0,e.lazy&&(I=bh(s.value,e.intersectionObserverOptions,C))});no(()=>{F(),I==null||I()})});const k=D(!e.lazy);return{textRef:a,selfRef:s,mergedRoundRef:v,mergedClsPrefix:t,fitTextTransform:l,cssVars:o?void 0:b,themeClass:g==null?void 0:g.themeClass,onRender:g==null?void 0:g.onRender,hasLoadError:r,handleError:h,shouldStartLoading:C,loaded:k,mergedOnLoad:I=>{var F;const{onLoad:w,imgProps:R}=e;w==null||w(I),(F=R==null?void 0:R.onLoad)===null||F===void 0||F.call(R,I),k.value=!0}}},render(){var e,t;const{$slots:o,src:r,mergedClsPrefix:n,lazy:a,onRender:s,mergedOnLoad:l,shouldStartLoading:d,loaded:c,hasLoadError:u}=this;s==null||s();let f;const v=!c&&!u&&(this.renderPlaceholder?this.renderPlaceholder():(t=(e=this.$slots).placeholder)===null||t===void 0?void 0:t.call(e));return this.hasLoadError?f=this.renderFallback?this.renderFallback():tt(o.fallback,()=>[i("img",{src:this.fallbackSrc,style:{objectFit:this.objectFit}})]):f=dt(o.default,p=>{if(p)return i(Uo,{onResize:this.fitTextTransform},{default:()=>i("span",{ref:"textRef",class:`${n}-avatar__text`},p)});if(r){const{imgProps:h}=this;return i("img",Object.assign(Object.assign({},h),{loading:ni&&!this.intersectionObserverOptions&&a?"lazy":"eager",src:ni||d||c?r:void 0,onLoad:l,"data-image-src":r,onError:this.handleError,style:[h==null?void 0:h.style,{objectFit:this.objectFit},v?{height:"0",width:"0",visibility:"hidden",position:"absolute"}:""]}))}}),i("span",{ref:"selfRef",class:[`${n}-avatar`,this.themeClass],style:this.cssVars},f,a&&v)}}),Rh=()=>({gap:"-12px"}),zh={name:"AvatarGroup",common:Te,peers:{Avatar:Ps},self:Rh},Ph=zh,$h={width:"44px",height:"44px",borderRadius:"22px",iconSize:"26px"},Th={name:"BackTop",common:Te,self(e){const{popoverColor:t,textColor2:o,primaryColorHover:r,primaryColorPressed:n}=e;return Object.assign(Object.assign({},$h),{color:t,textColor:o,iconColor:o,iconColorHover:r,iconColorPressed:n,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .12)",boxShadowHover:"0 2px 12px 0px rgba(0, 0, 0, .18)",boxShadowPressed:"0 2px 12px 0px rgba(0, 0, 0, .18)"})}},Fh=Th,Ih={name:"Badge",common:Te,self(e){const{errorColorSuppl:t,infoColorSuppl:o,successColorSuppl:r,warningColorSuppl:n,fontFamily:a}=e;return{color:t,colorInfo:o,colorSuccess:r,colorError:t,colorWarning:n,fontSize:"12px",fontFamily:a}}},Bh=Ih,Dh={fontWeightActive:"400"},$s=e=>{const{fontSize:t,textColor3:o,textColor2:r,borderRadius:n,buttonColor2Hover:a,buttonColor2Pressed:s}=e;return Object.assign(Object.assign({},Dh),{fontSize:t,itemLineHeight:"1.25",itemTextColor:o,itemTextColorHover:r,itemTextColorPressed:r,itemTextColorActive:r,itemBorderRadius:n,itemColorHover:a,itemColorPressed:s,separatorColor:o})},Mh={name:"Breadcrumb",common:Je,self:$s},Oh=Mh,Ah={name:"Breadcrumb",common:Te,self:$s},_h=Ah,Hh=m("breadcrumb",`
 white-space: nowrap;
 cursor: default;
...
`,[y("ul",`
 ...
 align-items: center;
 justify-content: center;
 `,[oo({top:"50%",originalTransform:"translateY(-50%)"})]),Wf()]),P("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
 ...
 filter: blur(2px);
 content: "";
 `)])])])])]),Fv=Object.assign(Object.assign({},be.props),{value:String,show:{type:Boolean,default:void 0},defaultShow:Boolean,defaultValue:String,modes:{type:Array,default:()=>["rgb","hex","hsl"]},placement:{type:String,default:"bottom-start"},to:At.propTo,showAlpha:{type:Boolean,default:!0},showPreview:Boolean,swatches:Array,disabled:{type:Boolean,default:void 0},actions:{type:Array,default:null},internalActions:Array,size:String,renderLabel:Function,onComplete:Function,onConfirm:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Xy=J({name:"ColorPicker",props:Fv,setup(e,{slots:t}){const o=D(null);let r=null;const n=io(e),{mergedSizeRef:a,mergedDisabledRef:s}=n,{localeRef:l}=co("global"),{mergedClsPrefixRef:d,namespaceRef:c,inlineThemeDisabled:u}=je(e),f=be("ColorPicker","-color-picker",Tv,rv,e,d);Ke(la,{themeRef:f,renderLabelRef:xe(e,"renderLabel"),colorPickerSlots:t});const v=D(e.defaultShow),p=gt(xe(e,"show"),v);function h(O){const{onUpdateShow:oe,"onUpdate:show":pe}=e;oe&&ee(oe,O),pe&&ee(pe,O),v.value=O}const{defaultValue:b}=e,g=D(b===void 0?av(e.modes,e.showAlpha):b),C=gt(xe(e,"value"),g),k=D([C.value]),I=D(0),F=x(()=>Jr(C.value)),{modes:w}=e,R=D(Jr(C.value)||w[0]||"rgb");function S(){const{modes:O}=e,{value:oe}=R,pe=O.findIndex(Y=>Y===oe);~pe?R.value=O[(pe+1)%O.length]:R.value="rgb"}let B,$,z,L,E,V,j,W;const H=x(()=>{const{value:O}=C;if(!O)return null;switch(F.value){case"hsv":return ar(O);case"hsl":return[B,$,z,W]=zr(O),[..._l(B,$,z),W];case"rgb":case"hex":return[E,V,j,W]=Yt(O),[...ki(E,V,j),W]}}),K=x(()=>{const{value:O}=C;if(!O)return null;switch(F.value){case"rgb":case"hex":return Yt(O);case"hsv":return[B,$,L,W]=ar(O),[...jo(B,$,L),W];case"hsl":return[B,$,z,W]=zr(O),[...Ri(B,$,z),W]}}),ne=x(()=>{const{value:O}=C;if(!O)return null;switch(F.value){case"hsl":return zr(O);case"hsv":return[B,$,L,W]=ar(O),[...Sn(B,$,L),W];case"rgb":case"hex":return[E,V,j,W]=Yt(O),[...Si(E,V,j),W]}}),G=x(()=>{switch(R.value){case"rgb":case"hex":return K.value;case"hsv":return H.value;case"hsl":return ne.value}}),_=D(0),Z=D(1),ie=D([0,0]);function ce(O,oe){const{value:pe}=H,Y=_.value,ae=pe?pe[3]:1;ie.value=[O,oe];const{showAlpha:Be}=e;switch(R.value){case"hsv":de((Be?ir:$i)([Y,O,oe,ae]),"cursor");break;case"hsl":de((Be?Wo:zi)([...Sn(Y,O,oe),ae]),"cursor");break;case"rgb":de((Be?Do:Pi)([...jo(Y,O,oe),ae]),"cursor");break;case"hex":de((Be?No:Ur)([...jo(Y,O,oe),ae]),"cursor");break}}function we(O){_.value=O;const{value:oe}=H;if(!oe)return;const[,pe,Y,ae]=oe,{showAlpha:Be}=e;switch(R.value){case"hsv":de((Be?ir:$i)([O,pe,Y,ae]),"cursor");break;case"rgb":de((Be?Do:Pi)([...jo(O,pe,Y),ae]),"cursor");break;case"hex":de((Be?No:Ur)([...jo(O,pe,Y),ae]),"cursor");break;case"hsl":de((Be?Wo:zi)([...Sn(O,pe,Y),ae]),"cursor");break}}function ge(O){switch(R.value){case"hsv":[B,$,L]=H.value,de(ir([B,$,L,O]),"cursor");break;case"rgb":[E,V,j]=K.value,de(Do([E,V,j,O]),"cursor");break;case"hex":[E,V,j]=K.value,de(No([E,V,j,O]),"cursor");break;case"hsl":[B,$,z]=ne.value,de(Wo([B,$,z,O]),"cursor");break}Z.value=O}function de(O,oe){oe==="cursor"?r=O:r=null;const{nTriggerFormChange:pe,nTriggerFormInput:Y}=n,{onUpdateValue:ae,"onUpdate:value":Be}=e;ae&&ee(ae,O),Be&&ee(Be,O),pe(),Y(),g.value=O}function ue(O){de(O,"input"),Ct(Re)}function Re(O=!0){const{value:oe}=C;if(oe){const{nTriggerFormChange:pe,nTriggerFormInput:Y}=n,{onComplete:ae}=e;ae&&ae(oe);const{value:Be}=k,{value:We}=I;O&&(Be.splice(We+1,Be.length,oe),I.value=We+1),pe(),Y()}}function Ce(){const{value:O}=I;O-1<0||(de(k.value[O-1],"input"),Re(!1),I.value=O-1)}function re(){const{value:O}=I;O<0||O+1>=k.value.length||(de(k.value[O+1],"input"),Re(!1),I.value=O+1)}function ke(){de(null,"input"),h(!1)}function Ge(){const{value:O}=C,{onConfirm:oe}=e;oe&&oe(O),h(!1)}const Ze=x(()=>I.value>=1),Oe=x(()=>{const{value:O}=k;return O.length>1&&I.value<O.length-1});lt(p,O=>{O||(k.value=[C.value],I.value=0)}),Pt(()=>{if(!(r&&r===C.value)){const{value:O}=H;O&&(_.value=O[0],Z.value=O[3],ie.value=[O[1],O[2]])}r=null});const Ee=x(()=>{const{value:O}=a,{common:{cubicBezierEaseInOut:oe},self:{textColor:pe,color:Y,panelFontSize:ae,boxShadow:Be,border:We,borderRadius:Ye,dividerColor:et,[te("height",O)]:ut,[te("fontSize",O)]:it}}=f.value;return{"--n-bezier":oe,"--n-text-color":pe,"--n-color":Y,"--n-panel-font-size":ae,"--n-font-size":it,"--n-box-shadow":Be,"--n-border":We,"--n-border-radius":Ye,"--n-height":ut,"--n-divider-color":et}}),se=u?Qe("color-picker",x(()=>a.value[0]),Ee,e):void 0;function M(){var O;const{value:oe}=K,{value:pe}=_,{internalActions:Y,modes:ae,actions:Be}=e,{value:We}=f,{value:Ye}=d;return i("div",{class:[`${Ye}-color-picker-panel`,se==null?void 0:se.themeClass.value],onDragstart:et=>{et.preventDefault()},style:u?void 0:Ee.value},i("div",{class:`${Ye}-color-picker-control`},i(mv,{clsPrefix:Ye,rgba:oe,displayedHue:pe,displayedSv:ie.value,onUpdateSV:ce,onComplete:Re}),i("div",{class:`${Ye}-color-picker-preview`},i("div",{class:`${Ye}-color-picker-preview__sliders`},i(hv,{clsPrefix:Ye,hue:pe,onUpdateHue:we,onComplete:Re}),e.showAlpha?i(pv,{clsPrefix:Ye,rgba:oe,alpha:Z.value,onUpdateAlpha:ge,onComplete:Re}):null),e.showPreview?i($v,{clsPrefix:Ye,mode:R.value,color:K.value&&Ur(K.value),onUpdateColor:et=>{de(et,"input")}}):null),i(Sv,{clsPrefix:Ye,showAlpha:e.showAlpha,mode:R.value,modes:ae,onUpdateMode:S,value:C.value,valueArr:G.value,onUpdateValue:ue}),((O=e.swatches)===null||O===void 0?void 0:O.length)&&i(Pv,{clsPrefix:Ye,mode:R.value,swatches:e.swatches,onUpdateColor:et=>{de(et,"input")}})),Be!=null&&Be.length?i("div",{class:`${Ye}-color-picker-action`},Be.includes("confirm")&&i(St,{size:"small",onClick:Ge,theme:We.peers.Button,themeOverrides:We.peerOverrides.Button},{default:()=>l.value.confirm}),Be.includes("clear")&&i(St,{size:"small",onClick:ke,disabled:!C.value,theme:We.peers.Button,themeOverrides:We.peerOverrides.Button},{default:()=>l.value.clear})):null,t.action?i("div",{class:`${Ye}-color-picker-action`},{default:t.action}):Y?i("div",{class:`${Ye}-color-picker-action`},Y.includes("undo")&&i(St,{size:"small",onClick:Ce,disabled:!Ze.value,theme:We.peers.Button,themeOverrides:We.peerOverrides.Button},{default:()=>l.value.undo}),Y.includes("redo")&&i(St,{size:"small",onClick:re,disabled:!Oe.value,theme:We.peers.Button,themeOverrides:We.peerOverrides.Button},{default:()=>l.value.redo})):null)}return{mergedClsPrefix:d,namespace:c,selfRef:o,hsla:ne,rgba:K,mergedShow:p,mergedDisabled:s,isMounted:Oo(),adjustedTo:At(e),mergedValue:C,handleTriggerClick(){h(!0)},handleClickOutside(O){var oe;!((oe=o.value)===null||oe===void 0)&&oe.contains(Mo(O))||h(!1)},renderPanel:M,cssVars:u?void 0:Ee,themeClass:se==null?void 0:se.themeClass,onRender:se==null?void 0:se.onRender}},render(){const{$slots:e,mergedClsPrefix:t,onRender:o}=this;return o==null||o(),i("div",{class:[this.themeClass,`${t}-color-picker`],ref:"selfRef",style:this.cssVars},i(fr,null,{default:()=>[i(hr,null,{default:()=>i(kv,{clsPrefix:t,value:this.mergedValue,hsla:this.hsla,disabled:this.mergedDisabled,onClick:this.handleTriggerClick},{label:e.label})}),i(ur,{placement:this.placement,show:this.mergedShow,containerClass:this.namespace,teleportDisabled:this.adjustedTo===At.tdkey,to:this.adjustedTo},{default:()=>i(Bt,{name:"fade-in-scale-up-transition",appear:this.isMounted},{default:()=>this.mergedShow?Kt(this.renderPanel(),[[zo,this.handleClickOutside,void 0,{capture:!0}]]):null})})]}))}}),Iv={paddingSmall:"12px 16px 12px",paddingMedium:"19px 24px 20px",paddingLarge:"23px 32px 24px",paddingHuge:"27px 40px 28px",titleFontSizeSmall:"16px",titleFontSizeMedium:"18px",titleFontSizeLarge:"18px",titleFontSizeHuge:"18px",closeIconSize:"18px",closeSize:"22px"},Ms=e=>{const{primaryColor:t,borderRadius:o,lineHeight:r,fontSize:n,cardColor:a,textColor2:s,textColor1:l,dividerColor:d,fontWeightStrong:c,closeIconColor:u,closeIconColorHover:f,closeIconColorPressed:v,closeColorHover:p,closeColorPressed:h,modalColor:b,boxShadow1:g,popoverColor:C,actionColor:k}=e;return Object.assign(Object.assign({},Iv),{lineHeight:r,color:a,colorModal:b,colorPopover:C,colorTarget:t,colorEmbedded:k,colorEmbeddedModal:k,colorEmbeddedPopover:k,textColor:s,titleTextColor:l,borderColor:d,actionColor:k,titleFontWeight:c,closeColorHover:p,closeColorPressed:h,closeBorderRadius:o,closeIconColor:u,closeIconColorHover:f,closeIconColorPressed:v,fontSizeSmall:n,fontSizeMedium:n,fontSizeLarge:n,fontSizeHuge:n,boxShadow:g,borderRadius:o})},Bv={name:"Card",common:Je,self:Ms},Os=Bv,Dv={name:"Card",common:Te,self(e){const t=Ms(e),{cardColor:o,modalColor:r,popoverColor:n}=e;return t.colorEmbedded=o,t.colorEmbeddedModal=r,t.colorEmbeddedPopover=n,t}},As=Dv,Mv=y([m("card",`
 font-size: var(--n-font-size);
...
`,[Jo(),m("dropdown-option",`
 ...
 `))]);function Km(){return[T("fixed-left",`
 left: 0;
 position: sticky;
 z-index: 2;
 `,[y("&::after",`
...
`,[sn({enterDuration:"0.3s",leaveDuration:"0.8s"}),m("loading-bar",`
 ...
 overflow: hidden;
 padding: 0;
 `,[Cs({duration:".2s"})])]),m("menu-item-group",[m("menu-item-group-title",`
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
...
`,[m("result-icon",`
 ...
 `)])]),uy={small:20,medium:18,large:16},fy=Object.assign(Object.assign({},be.props),{description:String,stroke:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},strokeWidth:Number,rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0}}),C1=J({name:"Spin",props:fy,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=je(e),r=be("Spin","-spin",cy,dx,e,t),n=x(()=>{const{size:s}=e,{common:{cubicBezierEaseInOut:l},self:d}=r.value,{opacitySpinning:c,color:u,textColor:f}=d,v=typeof s=="number"?Ut(s):d[te("size",s)];return{"--n-bezier":l,"--n-opacity-spinning":c,"--n-size":v,"--n-color":u,"--n-text-color":f}}),a=o?Qe("spin",x(()=>{const{size:s}=e;return typeof s=="number"?String(s):s[0]}),n,e):void 0;return{mergedClsPrefix:t,compitableShow:sr(e,["spinning","show"]),mergedStrokeWidth:x(()=>{const{strokeWidth:s}=e;if(s!==void 0)return s;const{size:l}=e;return uy[typeof l=="number"?"medium":l]}),cssVars:o?void 0:n,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender}},render(){var e,t;const{$slots:o,mergedClsPrefix:r,description:n}=this,a=o.icon&&this.rotate,s=(n||o.description)&&i("div",{class:`${r}-spin-description`},n||((e=o.description)===null||e===void 0?void 0:e.call(o))),l=o.icon?i("div",{class:[`${r}-spin-body`,this.themeClass]},i("div",{class:[`${r}-spin`,a&&`${r}-spin--rotate`],style:o.default?"":this.cssVars},o.icon()),s):i("div",{class:[`${r}-spin-body`,this.themeClass]},i(Qo,{clsPrefix:r,style:o.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,class:`${r}-spin`}),s);return(t=this.onRender)===null||t===void 0||t.call(this),o.default?i("div",{class:[`${r}-spin-container`,this.themeClass],style:this.cssVars},i("div",{class:[`${r}-spin-content`,this.compitableShow&&`${r}-spin-content--spinning`]},o),i(Bt,{name:"fade-in-transition"},{default:()=>this.compitableShow?l:null})):l}}),hy=m("switch",`
 height: var(--n-height);
...
`,[y("&:first-child",{marginTop:0}),T("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[T("align-text",{paddingLeft:0},[y("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),y("&::before",`
 ...
 line-height: var(--n-line-height);
 color: var(--n-text-color);
`,[y("&:first-child","margin-top: 0;"),y("&:last-child","margin-bottom: 0;")]),yy=Object.assign(Object.assign({},be.props),{depth:[String,Number]}),z1=J({name:"P",props:yy,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=je(e),r=be("Typography","-p",Cy,Sa,e,t),n=x(()=>{const{depth:s}=e,l=s||"1",{common:{cubicBezierEaseInOut:d},self:{pFontSize:c,pLineHeight:u,pMargin:f,pTextColor:v,[`pTextColor${l}Depth`]:p}}=r.value;return{"--n-bezier":d,"--n-font-size":c,"--n-line-height":u,"--n-margin":f,"--n-text-color":s===void 0?v:p}}),a=o?Qe("p",x(()=>`${e.depth||""}`),n,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:n,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),i("p",{class:[`${this.mergedClsPrefix}-p`,this.themeClass],style:this.cssVars},this.$slots)}}),Tl=y("li",{transition:"color .3s var(--n-bezier)",lineHeight:"var(--n-line-height)",margin:"var(--n-li-margin)",marginBottom:0,color:"var(--n-text-color)"}),Fl=[y("&:first-child",`
 margin-top: 0;
 `),y("&:last-child",`
 margin-bottom: 0;
 `)],wy=y([m("ol",{fontSize:"var(--n-font-size)",padding:"var(--n-ol-padding)"},[T("align-text",{paddingLeft:0}),Tl,Fl]),m("ul",{fontSize:"var(--n-font-size)",padding:"var(--n-ul-padding)"},[T("align-text",{paddingLeft:0}),Tl,Fl])]),Sy=Object.assign(Object.assign({},be.props),{alignText:Boolean}),P1=J({name:"Ul",props:Sy,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=je(e),r=be("Typography","-xl",wy,Sa,e,t),n=x(()=>{const{common:{cubicBezierEaseInOut:s},self:{olPadding:l,ulPadding:d,liMargin:c,liTextColor:u,liLineHeight:f,liFontSize:v}}=r.value;return{"--n-bezier":s,"--n-font-size":v,"--n-line-height":f,"--n-text-color":u,"--n-li-margin":c,"--n-ol-padding":l,"--n-ul-padding":d}}),a=o?Qe("ul",void 0,n,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:n,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender}},render(){var e;const{mergedClsPrefix:t}=this;return(e=this.onRender)===null||e===void 0||e.call(this),i("ul",{class:[`${t}-ul`,this.themeClass,this.alignText&&`${t}-ul--align-text`],style:this.cssVars},this.$slots)}}),$1=J({name:"Li",render(){return i("li",null,this.$slots)}}),ky=J({name:"InjectionExtractor",props:{onSetup:Function},setup(e,{slots:t}){var o;return(o=e.onSetup)===null||o===void 0||o.call(e),()=>{var r;return(r=t.default)===null||r===void 0?void 0:r.call(t)}}}),Ry={message:LC,notification:XC,loadingBar:wC,dialog:Ng};function zy({providersAndProps:e,configProviderProps:t}){let r=tu(()=>i(ap,Aa(t),{default:()=>e.map(({type:l,Provider:d,props:c})=>i(d,Aa(c),{default:()=>i(ky,{onSetup:()=>n[l]=Ry[l]()})}))}));const n={app:r};let a;return xo&&(a=document.createElement("div"),document.body.appendChild(a),r.mount(a)),Object.assign({unmount:()=>{var l;if(r===null||a===null){ro("discrete","unmount call no need because discrete app has been unmounted");return}r.unmount(),(l=a.parentNode)===null||l===void 0||l.removeChild(a),a=null,r=null}},n)}function T1(e,{configProviderProps:t,messageProviderProps:o,dialogProviderProps:r,notificationProviderProps:n,loadingBarProviderProps:a}={}){const s=[];return e.forEach(d=>{switch(d){case"message":s.push({type:d,Provider:EC,props:o});break;case"notification":s.push({type:d,Provider:YC,props:n});break;case"dialog":s.push({type:d,Provider:jg,props:r});break;case"loadingBar":s.push({type:d,Provider:yC,props:a});break}}),zy({providersAndProps:s,configProviderProps:t})}const Py=()=>({}),$y={name:"Equation",common:Te,self:Py},Ty=$y,F1={name:"dark",common:Te,Alert:qf,Anchor:Jf,AutoComplete:mh,Avatar:Ps,AvatarGroup:Ph,BackTop:Fh,Badge:Bh,Breadcrumb:_h,Button:Jt,ButtonGroup:m0,Calendar:tv,Card:As,Carousel:Lv,Cascader:Uv,Checkbox:Dr,Code:Ls,Collapse:tp,CollapseTransition:np,ColorPicker:iv,DataTable:Hp,DatePicker:Qm,Descriptions:xg,Dialog:Id,Divider:qg,Drawer:Jg,Dropdown:pa,DynamicInput:bb,DynamicTags:zb,Element:Bb,Empty:br,Ellipsis:Xs,Equation:Ty,Form:Ab,GradientText:Gb,Icon:fm,IconWrapper:n0,Image:oC,Input:uo,InputNumber:b0,LegacyTransfer:gC,Layout:S0,List:$0,LoadingBar:F0,Log:O0,Menu:j0,Mention:_0,Message:v0,Modal:Dg,Notification:d0,PageHeader:U0,Pagination:Gs,Popconfirm:Y0,Popover:Cr,Popselect:Vs,Progress:Qd,Radio:Js,Rate:J0,Result:nx,Row:tC,Scrollbar:Qt,Select:Us,Skeleton:dy,Slider:lx,Space:Ld,Spin:ux,Statistic:vx,Steps:bx,Switch:Cx,Table:Px,Tabs:Bx,Tag:hs,Thing:Ox,TimePicker:yd,Timeline:Hx,Tooltip:Hn,Transfer:Vx,Tree:rc,TreeSelect:Ux,Typography:Gx,Upload:Zx,Watermark:Jx};export{k1 as $,f1 as A,h1 as B,F1 as C,T1 as D,yC as E,EC as F,jg as G,YC as H,s1 as I,ap as J,fy as K,C1 as L,i1 as M,rd as N,a1 as O,St as P,Br as Q,d1 as R,c1 as S,l1 as T,_v as U,S1 as V,w1 as W,Zy as X,R1 as Y,z1 as Z,hh as _,m1 as a,ay as a0,n1 as a1,u1 as a2,g1 as a3,Np as a4,t0 as a5,P1 as a6,$1 as a7,gp as a8,Qy as a9,p1 as b,od as c,Ky as d,y1 as e,kb as f,r1 as g,t1 as h,Xy as i,Jy as j,e1 as k,o1 as l,Yy as m,pd as n,Gy as o,bo as p,x1 as q,b1 as r,Hg as s,Ep as t,kh as u,Sb as v,qy as w,v1 as x,kn as y,Uy as z};
