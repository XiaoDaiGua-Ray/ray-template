...
`,[P("input, textarea",`
 ...
 box-shadow: var(--n-box-shadow-focus-${e});
 border: var(--n-border-focus-${e});
 `)])])]))]),sh=m("input",[T("disabled",[P("input-el, textarea-el",`
...
`,[y("ul",`
 ...
 align-items: center;
 justify-content: center;
 `,[oo({top:"50%",originalTransform:"translateY(-50%)"})]),Nf()]),P("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
